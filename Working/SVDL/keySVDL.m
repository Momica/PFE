...
if exist('../../DataRetrieved/session1/featuresSession1StripesDicos.mat') == 2
    disp('Dicos already exist. Loading dicos');
    load('../../DataRetrieved/session1/featuresSession1StripesDicos.mat');
    ...
    featuresStructure = load('../../DataRetrieved/session1/featuresSession1Stripes.mat');
    ...
    dicosName = '../../DataRetrieved/session1/featuresSession1StripesDicos.mat';
...
for n = 1:length(testFeatures)
    ...
    fid = fopen(['result/demo_result_stripes.txt'],'a');
    fprintf(fid,'\n%s\n','========================================');
