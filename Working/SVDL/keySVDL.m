...
if exist('/Users/baptistemetge/Code/PFE/Git/PFE/DataRetrieved/session1/featuresSession1ManyDicos.mat') == 2
    disp('Dicos already exist. Loading dicos');
    load('/Users/baptistemetge/Code/PFE/Git/PFE/DataRetrieved/session1/featuresSession1ManyDicos.mat');
    ...
    featuresStructure = load('/Users/baptistemetge/Code/PFE/Git/PFE/DataRetrieved/session1/featuresSession1Many.mat');
    ...
    dicosName = '/Users/baptistemetge/Code/PFE/Git/PFE/DataRetrieved/session1/featuresSession1ManyDicos.mat';
    save(dicosName,'dicos');
end

% Load testing structure
testFeaturesStructure = load('../../DataRetrieved/session4/featuresSession4Many.mat');
...
fprintf(fid,'\n%s\n','========================================');
%fprintf(fid,'%s%8f%s%8f%s%8f\n','lambda1 = ',parameters.lambda1,'lambda2 = ',parameters.lambda2,' lambda3= ',parameters.lambda3);
fprintf(fid,'%s%8f%s%8f%s%8f\n','weight 1 = ',dicos{1,1}.weight,'weight 2 = ',dicos{1,2}.weight,' weight 3= ',dicos{1,3}.weight,' weight 4= ',dicos{1,4}.weight,' weight 5= ',dicos{1,5}.weight,' weight 6= ',dicos{1,6}.weight,' weight 7= ',dicos{1,7}.weight,' weight 8= ',dicos{1,8}.weight,' weight 9= ',dicos{1,9}.weight,' weight 10= ',dicos{1,10}.weight);
%fprintf(fid,'%s%8f%s%8f\n','nDim = ',parameters.par.nDim,' lambda= ',parameters.lambda);
fprintf(fid,'%s%8f\n','reco_rate1 = ',correct_rate);
fclose(fid);
toc();
